    ...
    "Bb20": [function(require, module, exports) {
        ...
        function e() {
            var e = [ "无论何时<br>我都会记得夏天的蓝……", 
                     ...
                     "没有BUG的代码<br>是不完美的！", 
                     "《平安夜》<br>在床头挂个克莱因瓶<br>整个世界<br>都是你的礼物", 
                     "芝兰生于深林，不以无人而不芳<br>君子修道立德，不为穷困而改节", 
                     "每个人<br>都有一个世界<br>安静而孤独", 
                     "未经审视的人生<br>是不值得过的", 
                     "现实世界如果允许人类自由迁徙<br>那么人流的方向就是文明的方向",
                     "最是人间留不住<br>朱颜辞镜花辞树", 
                     "慢也好<br>步伐小也罢<br>是往前走就好", 
                     "有形的东西迟早会凋零<br>但只有回忆是永远不会凋零的", 
                     "我不曾回答什么时候会到达<br>就奔跑，奔跑，无所谓什么代价<br>我要出发顶着所有的喧哗<br>就奔跑，奔跑，活成一个盛夏", 
                     "永远不要低估你的潜能<br>永远不要放弃你的梦想", 
                     "我知道的<br>终有一天<br>我们会在这个光辉璀璨的时代重逢", 
                     "如果能摸摸我的头的话<br>我会很高兴的(。・ω・。)", 
                     "明月装饰了你的窗子<br>你装饰了别人的梦", 
                     "用你的笑容去改变这个世界<br>别让这个世界改变了你的笑容", 
                     "欲穷千里目<br>云深不知处", 
                     "儿童急走追黄蝶<br>一日看尽长安花", 
                     "吾生也有涯<br>而知也无涯<br>以有涯随无涯<br>快哉", 
                     "子在川上曰<br>逝者如斯<br>而未尝往也", 
                     "爱美之心<br>人皆有之<br>贤者能勿丧耳", 
                     "夜深忽梦少年事<br>一樽还酹江月", 
                     "回朕车以复路兮<br>知来者之可追", 
                     "若是你所期望的<br>那定会得到强烈的回应"  ]
              , i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
        function o(t, e) {
