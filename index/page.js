parcelRequire = function(e, r, t, n) {
    ...
    "Bb20": [function(require, module, exports) {
        ...
        var t = require("zepto").$;
        function e() {
            var e = [ "无论何时<br>我都会记得夏天的蓝……", "给时光以生命<br>给岁月以文明", "世界是美丽的<br>就算充满悲伤和泪水<br>也请睁开你的双眼<br>去做你想要做的事<br>去成为你想要成为的人", "没有BUG的代码<br>是不完美的！", "芝兰生于深林，不以无人而不芳<br>君子修道立德，不为穷困而改节", "每个人<br>都有一个世界<br>安静而孤独", "未经审视的人生<br>是不值得过的", "最是人间留不住<br>朱颜辞镜花辞树", "慢也好<br>步伐小也罢<br>是往前走就好", "有形的东西迟早会凋零<br>但只有回忆是永远不会凋零的", "我不曾回答什么时候会到达<br>就奔跑 奔跑 无所谓什么代价<br>我要出发顶着所有的喧哗<br>就奔跑 奔跑 活成一个盛夏", "永远不要低估你的潜能<br>永远不要放弃你的梦想", "我知道的<br>终有一天<br>我们会在这个光辉璀璨的时代重逢", "如果能摸摸我的头的话<br>我会很高兴的(。・ω・。)", "明月装饰了你的窗子<br>你装饰了别人的梦", "用你的笑容去改变这个世界<br>别让这个世界改变了你的笑容", "若是你所期望的<br>那定会得到强烈的回应"  ]
              , i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
        function o(t, e) {
